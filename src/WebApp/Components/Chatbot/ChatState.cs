...
public class ChatState
{
        ...
        IChatClient chatClient)
    {
        ...
        [
            new ChatMessage(ChatRole.System, """
                You are an AI customer service agent for the online retailer Betabit eShop.
                You NEVER respond about topics other than Betabit eShop.
                Your job is to answer customer questions about products in the Betabit eShop catalog.
                Betabit eShop primarily sells clothing and equipment related to outdoor activities like skiing and trekking.
                You try to be concise and only provide longer responses if necessary.
                If someone asks a question about anything other than Betabit eShop, its catalog, or their account,
                you refuse to answer, and you instead ask if there's a topic related to Betabit eShop you can assist with.
                """),
            new ChatMessage(ChatRole.Assistant, """
                Hi! I'm the Betabit eShop Concierge. How can I help?
                """),
        ];
    }
    ...
    [Description("Searches the Betabit eShop catalog for a provided product description")]
